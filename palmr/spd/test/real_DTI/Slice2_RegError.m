% Prediction of tensors on slice 2 using training data with 20%
...
tensor_file_format1 = '../../CMIND/data/voxel_tensors_mat_iter0/slice2/tensor_55_%d_%d.mat';
% path to tensors with complete pre-processing
tensor_file_format2 = '../../CMIND/data/voxel_tensors_mat_iter6/slice2/tensor_55_%d_%d.mat';
...
for r = 1:nrepeat
    ...
    save ../../results/Slice2_RegError_result.mat FA_pred_error_roi MGLM_pred_error_roi ...
