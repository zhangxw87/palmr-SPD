% Print results and plot prediction errors on slice 6
%
% Written by Xiaowei Zhang 
% updated on 2017/02/15

clear all; close all; clc;
load('../../results/Slice6_NoError_result.mat');
load('../../results/Slice6_ManuError_result.mat');
load('../../results/Slice6_RegError_result.mat')
