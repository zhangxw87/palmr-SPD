% Prediction of tensors on slice 1 using training data with 20% manual
% gross error
%
...
tensor_file_format = '../../CMIND/data/voxel_tensors_mat_iter6/slice1/tensor_%d_%d_32.mat';
...
for r = 1:nrepeat
    ...
    save ../../results/Slice1_ManuError_result.mat FA_pred_error_noise PALMR_FA_error_noise ...
