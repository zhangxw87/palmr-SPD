% Print results and plot prediction errors on slice 1
%
% Written by Xiaowei Zhang 
% updated on 2017/02/15

clear all; close all; clc;
load('../../results/Slice1_NoError_result.mat');
load('../../results/Slice1_ManuError_result.mat');
load('../../results/Slice1_RegError_result.mat')
load('../../CMIND/data/wm_mask.mat')
mask = squeeze( mask(:, :, 32) );
mask = logical(mask);
NumVoxel = sum(mask(:));
