% Prediction of tensors on slice 6 using training data with 20%
...
tensor_file_format1 = '../../CMIND/data/voxel_tensors_mat_iter0/slice6/tensor_%d_45_%d.mat';
% path to tensors with complete pre-processing
tensor_file_format2 = '../../CMIND/data/voxel_tensors_mat_iter6/slice6/tensor_%d_45_%d.mat';
...
for r = 1:nrepeat
    ...
    save ../../results/Slice6_RegError_result.mat FA_pred_error_roi MGLM_pred_error_roi ...
