% Prediction of tensors on slice 1 using training data with 20%
...
mask = squeeze( mask(:, :, 32) ); % for difference slices, change the index
[mask_dim1, mask_dim2] = size(mask);

%% pathes to tensors on slice 1

% path to tensors with registration error
tensor_file_format1 = '../../CMIND/data/voxel_tensors_mat_iter0/slice1/tensor_%d_%d_32.mat';
% path to tensors with complete pre-processing
tensor_file_format2 = '../../CMIND/data/voxel_tensors_mat_iter6/slice1/tensor_%d_%d_32.mat';
...
for r = 1:nrepeat
    ...
    save ../../results/Slice1_RegError_result.mat FA_pred_error_roi MGLM_pred_error_roi ...
