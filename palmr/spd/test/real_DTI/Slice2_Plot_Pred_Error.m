% Print results and plot prediction errors on slice 2
%
% Written by Xiaowei Zhang 
% updated on 2017/02/15

clear all; close all; clc;
load('../../results/Slice2_NoError_result.mat');
load('../../results/Slice2_ManuError_result.mat');
load('../../results/Slice2_RegError_result.mat')
