% Print results and plot prediction errors on slice 5
%
% Written by Xiaowei Zhang 
% updated on 2017/02/15

clear all; close all; clc;
load('../../results/Slice5_NoError_result.mat');
load('../../results/Slice5_ManuError_result.mat');
load('../../results/Slice5_RegError_result.mat')
