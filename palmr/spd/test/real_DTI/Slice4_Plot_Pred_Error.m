% Print results and plot prediction errors on slice 4
%
% Written by Xiaowei Zhang 
% updated on 2017/02/15

clear all; close all; clc;
load('../../results/Slice4_NoError_result.mat');
load('../../results/Slice4_ManuError_result.mat');
load('../../results/Slice4_RegError_result.mat')
