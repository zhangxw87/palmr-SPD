% Prediction of tensors on slice 6 using training data with no gross error
%
...
for r = 1:nrepeat
    ...
    save Slice6_NoError_result.mat mask FA_pred_error PALMR_FA_error ...
