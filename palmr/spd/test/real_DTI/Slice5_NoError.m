% Prediction of tensors on slice 5 using training data with no gross error
%
...
for r = 1:nrepeat
    ...
    save Slice5_NoError_result.mat mask FA_pred_error PALMR_FA_error ...
