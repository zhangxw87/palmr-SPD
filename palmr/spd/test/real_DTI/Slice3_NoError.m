% Prediction of tensors on slice 3 using training data with no gross error
%
...
for r = 1:nrepeat
    ...
    save Slice3_NoError_result.mat mask FA_pred_error PALMR_FA_error ...
