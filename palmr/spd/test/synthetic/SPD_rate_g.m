% experiments on SPD manifolds investingating the effect of rate_g, the
% fraction of training samples corrupted by gross error
%
...
for i = 1:nrepeat
    ...
    save ../../results/SPD_rate_g_result.mat OutputNoG OutputWithG;
end
