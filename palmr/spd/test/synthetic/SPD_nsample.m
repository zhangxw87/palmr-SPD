% experiments on SPD manifolds investingating the effect of the number of
% training data
%
...
nsampleSet = 5:5:30; % number of training data = [50, 100, 150, 200, 250, 300]
...
for i = 1:nrepeat
    ...
    for j = 1:length(nsampleSet)
        para.nsample = nsampleSet(j);    
    ...
    save ../../results/SPD_nsample_result.mat OutputNoG OutputWithG;
end
